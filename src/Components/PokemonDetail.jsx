...
const pokemonData = [
  { id: 0, name: 'Articuno', number: '0144', type: 'Ice', image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/144.png', health: 202, attack: 72, defense: 46 },
  ...
  { id: 25, name: 'BocilKu', number: '0172', type: 'Electric', image: 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/172.png', health: 999, attack: 999, defense: 999 },
];
  ...
  return (
    <div className="pokemon-detail-container">
      <div className="detail-header">
        <div className="path">Pokémon</div>
      </div>
